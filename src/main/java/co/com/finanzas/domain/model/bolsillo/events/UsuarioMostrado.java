...
public class UsuarioMostrado extends DomainEvent {
    private final UsuarioId uid;
    private final Nombre nombre;
    private final Email email;

    public UsuarioMostrado(UsuarioId uid, Nombre nombre, Email email) {
        super("finanzas.usuario.mostrado");
        this.uid = uid;
        this.nombre = nombre;
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        UsuarioMostrado that = (UsuarioMostrado) o;
